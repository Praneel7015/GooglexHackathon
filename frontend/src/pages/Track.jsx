  ...
  return (
    <div className="max-w-md mx-auto p-4 md:p-6">
      ...
      <Card tone="mist" padding="p-3" className="mt-3">
        ...
        <div className="text-[10px] font-sans text-coffee/65 mt-1.5">Based on Ward 95 history · 142 similar cases</div>
      </Card>
          ...
          return (
            <div key={i} className="flex gap-3 py-1.5 items-start">
              <div className="w-7 flex justify-center pt-0.5">
                <span className={[
                  'w-3.5 h-3.5 rounded-full border-[1.5px] border-line',
      ...
      <Link to="/dashboard" className="block mt-6 font-sans text-[12px] text-olive font-semibold underline">View on public dashboard →</Link>
